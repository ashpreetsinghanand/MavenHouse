...
const Navbar = () => {
  ...
  return (
    <>
      <div>
        <nav
          className=" py-2  h-20 mx-auto flex 
          ...
          <ul className="center gap-8">
              ...
              <li>
                <div className="dropdown relative">
                  ...
                  >
                    ...
                    {notificationCount > 0 && (
                      <span className="absolute top-[-12px] right-[-8px] w-6 h-6 bg-gray-800 center text-white rounded-full text-[12px]">
                        {notificationCount}
                      </span>
                    )}
                  </button>
            ...
            {user ? (
              <li className="cursor-pointer login-navbar">
                <div className="w-8 cursor-pointer outline-4  outline-[#3E4046] border border-white h-8 bg-[#9B9B9B] rounded-full  text-sm center">
                  M
                </div>
                ...
                <div className=" login-secound z-50 min-w-[220px]">
                  <ul className="list-none whitespace-nowrap">
                    <li>
                      <NavLink to="/dashboard/my-tickets" className="sidebar">
                        My Tickets
                      </NavLink>
                    </li>
                    <li>
                      <NavLink to="/dashboard/profile" className="sidebar">
                        Profile
                      </NavLink>
                    </li>
                    <li>
                      <NavLink to="/dashboard/account" className="sidebar">
                        Account
                      </NavLink>
                    </li>
                    <li>
                      <button className="sidebar" onClick={showWallet}>
                        {" "}
                        Show Wallet
                      </button>
                    </li>
                    <li>
                      <button className="sidebar" onClick={sendTransaction}>
                        Send Transaction
                      </button>
                    </li>
                    <li>
                      <button className="sidebar" onClick={signMessage}>
                        Sign Message
                      </button>
                    </li>
                    <li>
                      <button onClick={() => logout()} className="sidebar ">
                        Sign Out
                      </button>
                    </li>
                  </ul>
              ...
              <li>
                ...
                {/* border-gray-600 bg-[#333333] tablet:px-5  rounded-3xl border */}
                <button
                  className="px-1  py-1 hover:bg-transparent hover:text-gray-400 duration-500 hover:underline-offset-8 hover:underline"
